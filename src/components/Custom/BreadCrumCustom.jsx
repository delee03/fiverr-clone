...
const BreadCrumCustom = ({
    ...
    tenNhom = "",
    tenChiTietLoai = "",
    desc = " Create, build, and develop your website with skilled website developers |",
}) => {
    return (
        <>
            <div className="flex items-center gap-2">
                ...
                <Link to="/cong-viec" className="text-sm hover:underline">
                    {" "}
                    {tenLoai}
                </Link>
                <Link to="/cong-viec" className="text-sm hover:underline">
            ...
            <div className="flex items-center gap-2 mb-5 -mt-2">
                <p className="text-gray-600">{desc.slice(0, 70) + "..."}</p>
